...
BOT_TOKEN = environ['BOT_TOKEN', "7871869495:AAExqqx7aF4nCO0MI0sLcVKfixBbytIpnqU"]
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002316696281').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = [int(auth_channel) for auth_channel in environ.get('AUTH_CHANNEL', '-1002316696281').split() if id_pattern.search(auth_channel)]
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://dqdarkfilter:dqdarkfilter@dqdarkfilter.h937k.mongodb.net/?retryWrites=true&w=majority&appName=dqdarkfilter")
DATABASE_NAME = environ.get('DATABASE_NAME', "dqdarkfilter")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002395926990'))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002316696281')).split()]
